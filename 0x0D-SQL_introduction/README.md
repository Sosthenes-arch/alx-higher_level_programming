# MySQL - Introduction
Project done during **Full Stack Software Engineering studies** at **ALX Africa: (sos-10-X)**. It aims to learn about databases, relational databases, subqueries, tables, **MySQL** statements and functions.
